...
tasks.withType<JavaCompile> {
    exclude("fluff/functions/template/**")
}
...
mavenPublishing {
    ...
    pom {
        name.set("Fluff Functions")
        description.set("A library offering a wide range of function combinations, supporting both native types and generics")
